"""
🎬 Video Extractor Server - Working Version
Simple and reliable video extraction API
"""
...
app = FastAPI(
    ...
    description="Professional video extraction service supporting 1000+ platforms",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
...
async def home():
    ...
    <html>
    <head>
        <title>🎬 Video Extractor Server</title>
        <style>
    ...
    <body>
        <div class="header">
            <h1>🎬 Video Extractor Server</h1>
            <p>Professional video extraction API</p>
        </div>
    ...
    try:
        ...
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
            ...
            clean_info = {
                ...
                "upload_date_formatted": _format_date(info.get("upload_date")),
...
if __name__ == "__main__":
    print("🎬 Video Extractor Server - Working Version")
    print("=" * 50)
